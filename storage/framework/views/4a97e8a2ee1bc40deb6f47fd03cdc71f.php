...
<div class="tabs">
    ...
    <a href="<?php echo e(route('shipments.index', ['status' => 'payment_pending'])); ?>" class="tab-btn <?php echo e(request('status') === 'payment_pending' ? 'active' : ''); ?>">بانتظار الدفع</a>
    <a href="<?php echo e(route('shipments.index', ['status' => 'in_transit'])); ?>" class="tab-btn <?php echo e(request('status') === 'in_transit' ? 'active' : ''); ?>">في الطريق</a>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $shipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="td-mono"><?php echo e($s->carrier_shipment_id ?? $s->tracking_number); ?></td>
...
<?php endif; ?></td>
                    ...
                    <td style="font-family:monospace"><?php echo e(number_format($s->total_charge ?? 0, 2)); ?> ر.س</td>
                    <td class="td-actions">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\shipping-gateway-blade\resources\views/pages/shipments/index.blade.php ENDPATH**/ ?>