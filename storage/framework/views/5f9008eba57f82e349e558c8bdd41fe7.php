...
<div class="portal-page">
    ...
    <div class="portals-grid">
        ...
        <a href="<?php echo e(route('b2c.login')); ?>" class="portal-door b2c">
        ...
        <a href="<?php echo e(route('b2b.login')); ?>" class="portal-door b2b">
            <div class="door-icon">🏢</div>
        ...
        <a href="<?php echo e(route('admin.login')); ?>" class="portal-door admin">
