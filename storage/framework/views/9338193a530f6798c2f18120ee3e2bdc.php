...
<body>
    <div class="login-card">
        ...
        <form method="POST" action="<?php echo e(route('b2c.login.submit')); ?>">
            <?php echo csrf_field(); ?>
        ...
        <div class="switch-portal">
            حساب منظمة؟
            <a href="<?php echo e(route('b2b.login')); ?>">سجّل دخول من بوابة B2B</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\shipping-gateway-blade\cebx-code\resources\views/b2c/b2c-login.blade.php ENDPATH**/ ?>